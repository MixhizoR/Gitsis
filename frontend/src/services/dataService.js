...
export const addField = (pid, name) =>
    api.post(`/projects/${pid}/fields`, { name });
export const deleteField = (pid, id) =>
    api.del(`/projects/${pid}/fields/${id}`);

// --- Gereksinimler ----------------------------------------------------------
export const listRequirements = (pid) =>
    api.get(`/projects/${pid}/requirements`);
export const createRequirement = (pid, data) =>
    api.post(`/projects/${pid}/requirements`, data);
export const updateRequirement = (pid, id, data) =>
    api.put(`/projects/${pid}/requirements/${id}`, data);
export const deleteRequirement = (pid, id) =>
    api.del(`/projects/${pid}/requirements/${id}`);
...
export const createTestCase = (pid, data) =>
    api.post(`/projects/${pid}/testcases`, data);
export const updateTestCase = (pid, id, data) =>
    api.put(`/projects/${pid}/testcases/${id}`, data);
export const deleteTestCase = (pid, id) =>
    api.del(`/projects/${pid}/testcases/${id}`);
...
export const createLink = (pid, body) =>
    api.post(`/projects/${pid}/links`, body);
export const bulkCreateLinks = (pid, body) =>
    api.post(`/projects/${pid}/links/batch`, body);
export const deleteLink = (pid, id) => api.del(`/projects/${pid}/links/${id}`);

// --- Sozluk (Glossary) ------------------------------------------------------
export const listGlossary = (pid) => api.get(`/projects/${pid}/glossary`);
export const createGlossary = (pid, data) =>
    api.post(`/projects/${pid}/glossary`, data);
export const updateGlossary = (pid, id, data) =>
    api.put(`/projects/${pid}/glossary/${id}`, data);
export const deleteGlossary = (pid, id) =>
    api.del(`/projects/${pid}/glossary/${id}`);
...
export const createRole = (pid, data) =>
    api.post(`/projects/${pid}/roles`, data);
export const updateRole = (pid, id, data) =>
    api.put(`/projects/${pid}/roles/${id}`, data);
...
export const createPersonnel = (pid, data) =>
    api.post(`/projects/${pid}/personnel`, data);
export const deletePersonnel = (pid, id) =>
    api.del(`/projects/${pid}/personnel/${id}`);

// --- Onay (consensus onay + kilitleme) --------------------------------------
export const listApprovals = (pid) => api.get(`/projects/${pid}/approvals`);
export const voteApproval = (pid, body) =>
    api.post(`/projects/${pid}/approvals/vote`, body);
export const unlockApproval = (pid, body) =>
    api.post(`/projects/${pid}/approvals/unlock`, body);
export const approvalMatrix = (pid, entityType, entityId) =>
    api.get(
        `/projects/${pid}/approvals/matrix?entityType=${entityType}&entityId=${entityId}`,
    );
