...
export const STRINGS = {
  tr: {
    ...
    'nav.documentLibrary': 'Dökümanlar',
    'nav.audit': 'Değişiklik Tarihçesi',
    'nav.snapshots': 'Snapshotlar',
    'nav.suspect': 'Şüpheli Bağlar',
    'nav.admin': 'Admin Paneli',
    'page.admin.title': 'Admin Paneli',
    'page.admin.sub': 'Kullanıcı yönetimi ve denetim kayıtları',
    'admin.console': 'Yönetim Konsolu',
    'admin.consoleSub': 'Sistem yönetimi — projelerden bağımsız',
    'admin.navUsers': 'Kullanıcı Yönetimi',
    'admin.navLogs': 'Denetim Kayıtları',
    'rolesAdmin.nav': 'Roller',
    'rolesAdmin.title': 'Sistem Roller',
    'rolesAdmin.subtitle':
      'Çekirdek roller ve 12 kademeli izin matrisi — değişiklikler oturum açan tüm kullanıcıları etkiler.',
    'rolesAdmin.newRole': 'Yeni Rol',
    'rolesAdmin.createTitle': 'Özel Rol Oluştur',
    'rolesAdmin.key': 'Rol Anahtarı',
    'rolesAdmin.keyHint': 'Küçük harf, rakam, _ ve - (2-32 karakter); sonradan değiştirilemez.',
    'rolesAdmin.name': 'Rol Adı',
    'rolesAdmin.permCount': 'İzin',
    'rolesAdmin.system': 'Sistem',
    'rolesAdmin.editPerms': 'İzinleri Yönet',
    'rolesAdmin.deleteConfirm': '"{name}" rolünü silmek istediğinize emin misiniz?',
    'admin.users': 'Kullanıcılar',
    'admin.auditLogs': 'Denetim Kayıtları',
    'admin.newUser': 'Yeni Kullanıcı',
    'admin.username': 'Kullanıcı Adı',
    'admin.password': 'Şifre',
    'admin.passwordHint': 'Düzenlemede boş bırakılırsa değişmez',
    'admin.name': 'Ad Soyad',
    'admin.role': 'Rol',
    ...
    'admin.noLogs': 'Kayıt yok',
    'admin.unauthorized': 'Bu alan yalnızca Admin rolüne açıktır.',
    'admin.loading': 'Yükleniyor…',
    'admin.createTitle': 'Kullanıcı Oluştur',
    'admin.editTitle': 'Kullanıcı Düzenle',
    'admin.date': 'Tarih',
    'admin.action': 'Olay',
    ...
    'page.documentLibrary.title': 'Dökümanlar',
    'page.documentLibrary.sub':
      'Proje belge kütüphanesi · PDF ve Excel belgelerini yükleyin, saklayın',
    ...
    // --- Doküman Kütüphanesi (Dökümanlar sekmesi) ---
    'docs.uploadBtn': 'Belge yüklemek için tıklayın veya dosyayı buraya sürükleyin',
    'docs.uploadHint': 'PDF · XLSX · XLS · dosya başına en fazla 20 MB',
    'docs.uploading': 'Yükleniyor… %{p}',
    'docs.uploaded': '{count} belge kütüphaneye eklendi.',
    'docs.uploadError': 'Belge yüklenemedi.',
    'docs.loadError': 'Belge listesi yüklenemedi.',
    'docs.downloadError': 'Belge indirilemedi.',
    'docs.deleteError': 'Belge silinemedi.',
    'docs.deleted': '"{name}" silindi.',
    'docs.errType': 'Yalnızca PDF ve Excel (.xlsx, .xls) yüklenebilir: {name}',
    'docs.errSize': 'Dosya 20 MB sınırını aşıyor: {name}',
    'docs.confirmDelete': '"{name}" belgesi kalıcı olarak silinsin mi?',
    'docs.loading': 'Belgeler yükleniyor…',
    'docs.summary': '{count} belge · toplam {size}',
    'docs.searchPh': 'Belge adı veya yükleyen ara…',
    'docs.emptyTitle': 'Henüz belge yok',
    'docs.emptyDesc':
      'Bilgisayarınızdan PDF veya Excel belgesi yükleyin. Yüklenen belgeler bu kütüphanede kalıcı olarak saklanır.',
    'docs.noMatch': 'Eşleşen belge yok',
    'docs.noMatchDesc': 'Arama kriterlerinizi değiştirip tekrar deneyin.',
    'docs.thName': 'Belge',
    'docs.thType': 'Tip',
    'docs.thSize': 'Boyut',
    'docs.thUploadedBy': 'Yükleyen',
    'docs.thUploadedAt': 'Yüklenme',
    'docs.thActions': 'İşlemler',
    'docs.download': 'İndir',
    'docs.delete': 'Sil',
    'docs.modeOriginal': 'Orijinal',
    'docs.modeText': 'Metin',
    'docsel.hint': 'Metni seçin, çıkan + düğmesiyle (veya Alt+Enter) gereksinim oluşturun',
    'docsel.addShort': 'Gereksinim',
    'docsel.addAria': 'Seçili metinden yeni gereksinim oluştur',
    'docsel.addTitle': 'Seçili metinden gereksinim oluştur (Alt+Enter)',
    'docsel.alreadyUsed': 'Bu pasaj şu gereksinimlere kaynak: {list}',
    'docsel.duplicateWarn':
      'Bu pasaj zaten şu gereksinimlere kaynak: {list}. Yine de yeni bir gereksinim oluşturabilirsiniz.',
    'docsel.sourceLabel': 'Kaynak: {name}',
    'docsel.formTitle': 'Seçimden Gereksinim Oluştur',
    'view.source': 'Kaynak',
    'view.sourceDocument': 'Kaynak doküman',
    'view.sourceDeleted': 'Kaynak doküman silinmiş ({name})',
    ...
    'filt.button': 'Filtreler',
    'filt.done': 'Kapat',
    'filt.yes': 'Evet',
    'filt.no': 'Hayır',
    'filt.textPh': 'İçinde geçen…',
    'filt.numberPh': 'Değer',
    'filt.treeFlat':
    ...
    'tbl.rejectTitle': 'Reddet (Failed olarak işaretle) — tek yetkili yeterli',
    'tbl.votedTitle': 'Onayınız verildi (geri almak için tıklayın)',
    'tbl.approvedTitle': 'Tüm onaylar tamamlandı',

    // --- Kayıtlı Görünümler (Saved Views, Issue #105) ---
    'sv.label': 'Görünüm',
    'sv.none': '(Görünüm yok)',
    'sv.mine': 'Görünümlerim',
    'sv.shared': 'Proje geneli',
    'sv.unsaved': 'kaydedilmedi',
    'sv.layout': 'Düzen',
    'sv.columns': 'Sütunlar',
    'sv.moveUp': 'Yukarı taşı',
    'sv.moveDown': 'Aşağı taşı',
    'sv.rows': 'Satır düzeni',
    'sv.pageSize': 'Sayfa başına kayıt',
    'sv.allRows': 'Tümü',
    'sv.sortBy': 'Sıralama ölçütü',
    'sv.sortDir': 'Sıralama yönü',
    'sv.sortCreatedAt': 'Oluşturma tarihi',
    'sv.sortUpdatedAt': 'Güncelleme tarihi',
    'sv.asc': 'Artan (A→Z, 1→9)',
    'sv.desc': 'Azalan (Z→A, 9→1)',
    'sv.save': 'Kaydet',
    'sv.saveAs': 'Görünüm Kaydet',
    'sv.saveTitle': 'Görünümü kaydet',
    'sv.saveSub': 'Mevcut filtreler, sütun düzeni ve satır düzeni bir isimle saklanır.',
    'sv.name': 'Görünüm adı',
    'sv.namePh': 'Örn. Açık yazılım gereksinimleri',
    'sv.scope': 'Kapsam',
    'sv.scopeUser': 'Yalnızca ben',
    'sv.scopeProject': 'Proje geneli (paylaşılan)',
    'sv.makeDefault': 'Varsayılan yap',
    'sv.delete': 'Sil',
    'sv.error': 'Görünüm işlemi başarısız oldu.',
    'sv.pageOf': 'Sayfa {page}/{pageCount} · {total} kayıt',
    'sv.prev': 'Önceki',
    'sv.next': 'Sonraki',
    ...
    'view.assignees': 'Atanan Kişiler',
    'view.tab.detail': 'Detay',
    'view.tab.history': 'Geçmiş',
    'view.tab.comments': 'Yorumlar',
    'view.tab.commentsCount': 'Yorumlar ({n})',
    'comments.loading': 'Yorumlar yükleniyor…',
    'comments.loadError': 'Yorumlar yüklenemedi.',
    'comments.emptyTitle': 'Henüz yorum yok.',
    'comments.emptyHint': 'Bu kayıt hakkında ilk yorumu siz yapın.',
    'comments.placeholder': 'Yorumunuzu yazın…',
    'comments.add': 'Yorum Ekle',
    'comments.adding': 'Ekleniyor…',
    'comments.addError': 'Yorum eklenemedi.',
    'comments.delete': 'Yorumu sil',
    'comments.deleteAria': '{name} adlı kullanıcının yorumunu sil',
    'comments.deleteTitle': 'Yorumu silme gerekçesi',
    ...
    'snapshot.notOnAnyPage': 'Hiçbir menü sayfasına ait değil',
    'snapshot.sectionEmpty': 'Bu sayfada hiç kayıt yok.',
    ...
    'form.assignee': 'Atanan Kişiler',
    'form.assigneeNone': '(atanmamış)',
    'form.assigneeAdd': '+ Kişi ekle',
    'form.assigneeRemove': 'Atamayı kaldır',
    'form.assigneeMoveUp': 'Sırada yukarı taşı',
    'form.assigneeUnknown': '(silinmiş personel)',
  ...
  en: {
    ...
    'nav.documentLibrary': 'Documents',
    'nav.audit': 'Change History',
    'nav.admin': 'Admin Panel',
    'page.admin.title': 'Admin Panel',
    'page.admin.sub': 'User management and audit logs',
    'admin.console': 'Admin Console',
    'admin.consoleSub': 'System administration — independent of projects',
    'admin.navUsers': 'User Management',
    'admin.navLogs': 'Audit Logs',
    'rolesAdmin.nav': 'Roles',
    'rolesAdmin.title': 'System Roles',
    'rolesAdmin.subtitle':
      'Core roles and the 12-tier permission matrix — changes affect all logged-in users.',
    'rolesAdmin.newRole': 'New Role',
    'rolesAdmin.createTitle': 'Create Custom Role',
    'rolesAdmin.key': 'Role Key',
    'rolesAdmin.keyHint':
      'Lowercase letters, digits, _ and - (2-32 chars); cannot be changed later.',
    'rolesAdmin.name': 'Role Name',
    'rolesAdmin.permCount': 'Permissions',
    'rolesAdmin.system': 'System',
    'rolesAdmin.editPerms': 'Edit Permissions',
    'rolesAdmin.deleteConfirm': 'Are you sure you want to delete the "{name}" role?',
    'admin.users': 'Users',
    'admin.auditLogs': 'Audit Logs',
    'admin.newUser': 'New User',
    'admin.username': 'Username',
    'admin.password': 'Password',
    'admin.passwordHint': 'Leave blank when editing to keep unchanged',
    ...
    'admin.noLogs': 'No records',
    'admin.unauthorized': 'This area is available to the Admin role only.',
    ...
    'page.documentLibrary.title': 'Documents',
    'page.documentLibrary.sub': 'Project document library · upload and keep PDF and Excel files',
    ...
    // --- Document Library (Documents tab) ---
    'docs.uploadBtn': 'Click to upload a document or drop the file here',
    'docs.uploadHint': 'PDF · XLSX · XLS · up to 20 MB per file',
    'docs.uploading': 'Uploading… {p}%',
    'docs.uploaded': '{count} document(s) added to the library.',
    'docs.uploadError': 'Document could not be uploaded.',
    'docs.loadError': 'Document list could not be loaded.',
    'docs.downloadError': 'Document could not be downloaded.',
    'docs.deleteError': 'Document could not be deleted.',
    'docs.deleted': '"{name}" deleted.',
    'docs.errType': 'Only PDF and Excel (.xlsx, .xls) files are allowed: {name}',
    'docs.errSize': 'File exceeds the 20 MB limit: {name}',
    'docs.confirmDelete': 'Permanently delete "{name}"?',
    'docs.loading': 'Loading documents…',
    'docs.summary': '{count} document(s) · {size} total',
    'docs.searchPh': 'Search by file name or uploader…',
    'docs.emptyTitle': 'No documents yet',
    'docs.emptyDesc':
      'Upload a PDF or Excel document from your computer. Uploaded documents stay in this library.',
    'docs.noMatch': 'No matching documents',
    'docs.noMatchDesc': 'Try changing your search criteria.',
    'docs.thName': 'Document',
    'docs.thType': 'Type',
    'docs.thSize': 'Size',
    'docs.thUploadedBy': 'Uploaded by',
    'docs.thUploadedAt': 'Uploaded',
    'docs.thActions': 'Actions',
    'docs.download': 'Download',
    'docs.delete': 'Delete',
    'docs.modeOriginal': 'Original',
    'docs.modeText': 'Text',
    'docsel.hint': 'Select text, then use the + button (or Alt+Enter) to create a requirement',
    'docsel.addShort': 'Requirement',
    'docsel.addAria': 'Create a new requirement from the selected text',
    'docsel.addTitle': 'Create requirement from selection (Alt+Enter)',
    'docsel.alreadyUsed': 'This passage is the source of: {list}',
    'docsel.duplicateWarn':
      'This passage is already the source of: {list}. You can still create another requirement.',
    'docsel.sourceLabel': 'Source: {name}',
    'docsel.formTitle': 'Create Requirement from Selection',
    'view.source': 'Source',
    'view.sourceDocument': 'Source document',
    'view.sourceDeleted': 'Source document deleted ({name})',
    ...
    'tbl.rejectTitle': 'Reject (mark as Failed) — a single authorized approver is enough',
    'tbl.votedTitle': 'You approved (click to withdraw)',
    'tbl.approvedTitle': 'All approvals complete',

    // --- Saved Views (Issue #105) ---
    'sv.label': 'View',
    'sv.none': '(No view)',
    'sv.mine': 'My views',
    'sv.shared': 'Project-wide',
    'sv.unsaved': 'unsaved',
    'sv.layout': 'Layout',
    'sv.columns': 'Columns',
    'sv.moveUp': 'Move up',
    'sv.moveDown': 'Move down',
    'sv.rows': 'Row layout',
    'sv.pageSize': 'Rows per page',
    'sv.allRows': 'All',
    'sv.sortBy': 'Sort by',
    'sv.sortDir': 'Sort direction',
    'sv.sortCreatedAt': 'Created at',
    'sv.sortUpdatedAt': 'Updated at',
    'sv.asc': 'Ascending (A→Z, 1→9)',
    'sv.desc': 'Descending (Z→A, 9→1)',
    'sv.save': 'Save',
    'sv.saveAs': 'Save View',
    'sv.saveTitle': 'Save view',
    'sv.saveSub': 'Current filters, column layout and row layout are stored under a name.',
    'sv.name': 'View name',
    'sv.namePh': 'e.g. Open software requirements',
    'sv.scope': 'Scope',
    'sv.scopeUser': 'Only me',
    'sv.scopeProject': 'Project-wide (shared)',
    'sv.makeDefault': 'Make default',
    'sv.delete': 'Delete',
    'sv.error': 'View operation failed.',
    'sv.pageOf': 'Page {page}/{pageCount} · {total} records',
    'sv.prev': 'Previous',
    'sv.next': 'Next',
    ...
    'view.tab.comments': 'Comments',
    'view.tab.commentsCount': 'Comments ({n})',
    'comments.loading': 'Loading comments…',
    'comments.loadError': 'Comments could not be loaded.',
    'comments.emptyTitle': 'No comments yet.',
    'comments.emptyHint': 'Be the first to comment on this record.',
    'comments.placeholder': 'Write your comment…',
    'comments.add': 'Add Comment',
    'comments.adding': 'Adding…',
    'comments.addError': 'Comment could not be added.',
    'comments.delete': 'Delete comment',
    'comments.deleteAria': "Delete {name}'s comment",
    'comments.deleteTitle': 'Reason for deleting the comment',
    ...
    'form.assigneeAdd': '+ Add person',
    'form.assigneeRemove': 'Remove assignment',
    'form.assigneeMoveUp': 'Move up in order',
    'form.assigneeUnknown': '(deleted personnel)',
    ...
    'snapshot.notOnAnyPage': 'Not on any menu page',
    'snapshot.sectionEmpty': 'No records on this page.',
