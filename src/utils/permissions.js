...
export const PERMISSION_DEFS = [
  { key: 'read', num: 1, label: 'Okuma', desc: 'Gösterge paneli, hiyerarşi ve kapsam raporlarına erişim; göz ikonu ile detaylı görüntüleme.', scope: 'all' },
  { key: 'write', num: 2, label: 'Yazma / Düzenleme', desc: 'Kalem ikonu aktif: öncelik, alan ve DAL düzenleme + göz modalındaki zengin metin editörüyle açıklama.', scope: 'all' },
  { key: 'add_requirement', num: 3, label: 'Gereksinim Ekleme', desc: '“Gereksinim Ekle” butonlarını etkinleştirir.', scope: 'req' },
  { key: 'add_test', num: 4, label: 'Test Ekleme', desc: '“Test Senaryosu Ekle” butonlarını etkinleştirir.', scope: 'test' },
  { key: 'delete', num: 5, label: 'Silme', desc: 'Çöp kutusu ikonunu etkinleştirir.', scope: 'all' },
  { key: 'link_satisfies', num: 6, label: 'Satisfies Bağı', desc: 'Satisfies bağı ekleme/silme (Sistem→Kullanıcı, Alt-sistem→Sistem).', scope: 'satisfies' },
  { key: 'link_verifies', num: 7, label: 'Verifies Bağı', desc: 'Verifies bağı ekleme/silme.', scope: 'test' },
  { key: 'link_assigned', num: 8, label: 'Assigned To Bağı', desc: 'Sözlük “Assigned To” bağı ekleme/silme.', scope: 'req' },
  { key: 'manage_roles', num: 9, label: 'Rol Yönetimi', desc: 'Rol ekleme/silme/atama; Roller sayfasına erişim sağlar.', scope: 'toggle' },
  { key: 'manage_projects', num: 10, label: 'Proje Yönetimi', desc: 'Giriş ekranında proje ekleme/silme yetkisi.', scope: 'toggle' },
  { key: 'manage_fields', num: 11, label: 'Alanları Yönetme', desc: '“Alanları Yönet” işlevini etkinleştirir.', scope: 'toggle' },
  { key: 'approve', num: 12, label: 'Onaylama', desc: 'Onay (Check Circle) butonunu etkinleştirir; consensus oyuna katılır.', scope: 'all' },
]
